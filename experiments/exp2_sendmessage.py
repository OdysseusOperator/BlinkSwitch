"""
Experiment 2: Send F11 using SendMessage (synchronous)
"""
...
def main():
    ...
    # Send F11 using SendMessage
    print("Sending F11 via SendMessage...")
    VK_F11 = 0x7A
    win32api.SendMessage(hwnd, win32con.WM_KEYDOWN, VK_F11, 0)
    time.sleep(0.05)
    win32api.SendMessage(hwnd, win32con.WM_KEYUP, VK_F11, 0xC0000001)
